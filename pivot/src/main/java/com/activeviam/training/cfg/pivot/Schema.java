...
public class Schema {
	...
	public static ISelectionDescription createSchemaSelectionDescription(
		...
		return StartBuilding.selection(datastoreDescription)
				...
				// Buckets
				.usingReference(joinName(RISK_BUCKET_STORE_NAME, MD_BUCKET_SOD_STORE_NAME) + "/" + joinName(MD_BUCKET_SOD_STORE_NAME, BUCKETS_STORE_NAME))
				.withAllFields().except(MD_BUCKET__MDBUCKET)
